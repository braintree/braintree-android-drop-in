...
- Upgrade your integration to continue accepting Braintree payments The SSL certificates for the Android SDK are set to expire by March 30, 2026. Upgrade to v6.16.0+ to continue using the Braintree SDK.
