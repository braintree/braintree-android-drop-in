...
- Upgrade your integration to continue accepting Braintree payments. The SSL certificates for the Android SDK v5.4.2 through v6.15.0 are set to expire by March 30, 2026. Upgrade to v6.16.0+ to continue using the Braintree SDK. Versions below v5.4.2 need to update ASAP to v5.4.2 and ideally to the latest version of the SDK.
