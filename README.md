...
Drop-In is currently localized for [23 languages](https://github.com/braintree/braintree-android-drop-in/tree/master/Drop-In/src/main/res). To view localized text for a specific local, open its corresponding `values-<LOCALE_NAME>/strings.xml` resource file.
