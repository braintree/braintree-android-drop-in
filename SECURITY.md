...
* Report a [vulnerability](https://github.com/braintree/braintree-android-drop-in/security/advisories/new) directly via private vulnerability reporting on GitHub
