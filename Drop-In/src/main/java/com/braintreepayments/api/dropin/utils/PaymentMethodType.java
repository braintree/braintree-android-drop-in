...
public enum PaymentMethodType {
    ...
    ANDROID_PAY(R.drawable.bt_ic_android_pay, R.string.bt_descriptor_android_pay, "Android Pay"),
    ...
    PAYPAL(R.drawable.bt_ic_paypal, R.string.bt_descriptor_paypal, "PayPal"),
    VISA(CardType.VISA.getFrontResource(), R.string.bt_descriptor_visa, "Visa"),
    PAY_WITH_VENMO(R.drawable.bt_ic_venmo, R.string.bt_descriptor_pay_with_venmo, "Venmo"),
