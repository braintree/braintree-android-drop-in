...
public class DropInRequestUnitTest {
    ...
    public void includesAllOptions() {
        ...
        PayPalCheckoutRequest paypalRequest = new PayPalCheckoutRequest("10");
